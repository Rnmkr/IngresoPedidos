...
namespace IngresoPedidos
{
    ...
    public partial class ListaPedidos : UserControl
    {
        ...
        private void btnCambiarContraseña_Click(object sender, RoutedEventArgs e)
        {
            ...
            ccw.Owner = Window.GetWindow(this.Parent);
            ccw.ShowDialog();
        }
        ...
        private void btnFiltrarLista_Click(object sender, RoutedEventArgs e)
        {
            ...
            flw.Owner = Window.GetWindow(this.Parent);
            flw.ShowDialog();
            dgPedidos.ItemsSource = null;
            dgPedidos.ItemsSource = StaticData.ListaPrincipal;
        }
        ...
        private void MenuItem_Click(object sender, RoutedEventArgs e)
        {
            ...
            ao.Owner = Window.GetWindow(this.Parent);
            ao.ShowDialog();
        }
        ...
        private void HyperlinkAnterior_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (pedidoAnterior == null)
            {
                ...
                mostrarPedidoPopUp.Owner = Window.GetWindow(this.Parent);
        ...
        private void MenuItem_Click_2(object sender, RoutedEventArgs e)
        {
            if (UserRightValidation.CanExecute("VER_REGISTRO_EVENTOS", true))
            {
                ...
                re.Owner = Window.GetWindow(this.Parent);
                re.ShowDialog();
